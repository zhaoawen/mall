        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              ...
              <div class="add">
                <!-- 在加入购物车之前，进行路由跳转之前，发请求 把购买的产品信息通过请求的形式通知服务器，服务器进行相应的存储-->
    ...
    methods: {
      ...
      async addShopcar(){
        ...
        try {
          ...
          // 一些简单的数据通过query传递过去，复杂数据（skuInfo）通过会话存储（一般存储的是字符串）
          sessionStorage.setItem("SKUINFO",JSON.stringify(this.skuInfo));
          this.$router.push({name:'addcartaucess',query:{skuNum:this.skuNum}});
          // 本地存储
        } catch (error) {
          // 失败啦 
          alert(error.message);
