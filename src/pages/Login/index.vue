        ...
        <div class="loginform">
          ...
          <div class="content">
            <form >
              ...
              <div class="input-text clearFix">
                <span class="pwd"></span>
                <input placeholder="请输入密码" v-model="password" name="password" v-validate="{required:true,regex:/^1[0-9A-Za-z]{8,20}$/}"  :class="{invalid:errors.has('password')}" />
      ...
      async userLogin(){
        ...
        if(success){
          try {
            ...
            // 登录的时候，看路径当中是否包含query参数，如果有就跳到参数指定参数
